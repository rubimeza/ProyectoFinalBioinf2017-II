...
Carpeta software.
-
En ella se encuentra un archivo en .md que contiene los enlaces de las dependencias necesarias para poder correr el análisis. Sin ellas no podrás correr llevar a cabo el ensamble de las secuencias.
...
Archivo wiki
-
Puedes revisar el archivo [wiki]() para seguir el tutorial del análisis. 
